...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggle}
      className="inline-flex h-8 w-8 items-center justify-center rounded-md border border-[color:var(--color-rule)] text-muted transition-colors hover:text-ink hover:border-[color:var(--color-ink)]"
